...
@ComparatorClass("SubStringLevenshtein")
public class SubStringLevenshtein extends AbstractDistanceAlgo {
     ...
     *            the w
     */
    public SubStringLevenshtein(final double w) {
        super(w, new com.wcohen.ss.Levenstein());
    }

    public SubStringLevenshtein(Map<String, Number> params){
     ...
     *            the limit
     */
    public SubStringLevenshtein(final double w, final int limit) {
        super(w, new com.wcohen.ss.Levenstein());
        this.limit = limit;
    }
     ...
     *            the ssalgo
     */
    protected SubStringLevenshtein(final double w, final int limit, final AbstractStringDistance ssalgo) {
        super(w, ssalgo);
        this.limit = limit;
    }
